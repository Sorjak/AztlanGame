...
{
	/// <summary>
	/// A damage movement which plays an animation and moves the character.
	/// </summary>
	public class DamageMovement_AnimationAndMove : DamageMovement
	{
        ...
        protected Vector2 damageVector;
		...
		/// Human readable name.
		/// </summary>
		private const string Name = "Animation And Move";
		
		/// <summary>
		/// Human readable description.
		/// </summary>
		private const string Description = "A damage movement which plays an animation by setting an animation state and then also moves character. For death movement it plays the death animation and does not give control back.";
		...
		override public void DoMove()
		{
            if (animationTimer > 0)
            {
                character.Translate(damageVector.x * TimeManager.FrameTime, damageVector.y * TimeManager.FrameTime, false);
            }
		}
		...
		override public void Damage(DamageInfo info, bool isDeath)
		{
            ...
            damageVector = -info.Direction * info.Amount;
        ...
        override public int FacingDirection
        {
            get
            {
                return (int) -Mathf.Sign(damageVector.x);
            }
        }
